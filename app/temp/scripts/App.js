...
var Modal = function () {
  ...
  _createClass(Modal, [{
    ...
    value: function openModal() {
      ...
      //must include include false to prevent default behaviour of scrolling up
      return false;
    }
  }, {
    key: 'closeModal',
...
var StickyHeader = function () {
  ...
  _createClass(StickyHeader, [{
    ...
    value: function createHeaderWaypoint() {
      var that = this;
      new Waypoint({
        //when using vanillaJs, element expects the native dom element
        //with jquery, access the first array to achieve that
